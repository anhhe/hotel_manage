                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="card user-card">
                                            ...
                                            <div class="card-body  text-center">
                                                ...
                                                <h6 class="f-w-600 m-t-25 m-b-10">${sessionScope.account.getDisplayName()}</h6>
                                                <p>${a.isStatus() == true ? "Hoạt động" : "Không còn hoạt động"} | ${a.isGender() == true ? "Nam": "Nữ"} | ${a.getPhone()}</p>
                                                <hr>
                                                <p class="m-t-15">${a.getPhone()}</p>
