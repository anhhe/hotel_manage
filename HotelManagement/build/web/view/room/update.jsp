                                    ...
                                    <form action="update" method="POST">
                                        ...
                                        <table class="table table-striped" style="border: 1px solid black;">
                                            <tr>
                                                ...
                                                <td><input style="border: 1px solid black;" name="name" value="${r.getRoomName()}" type="text" class="form-control" placeholder="Room type name" aria-describedby="basic-addon1"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="roomtype">
                                                        <c:forEach items="${list}" var="rt">
                                                            <option value="${rt.getID()}" ${rt.getID() == r.getRoomType().getID() ? "selected":""}>${rt.getRoomTypeName()}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="status">
                                                        <option value="true" ${r.isStatus() == true ? "selected":""}>Con phong</option>
                                                        <option value="false" ${r.isStatus() == false ? "selected":""}>Het phong</option>
                                                    </select>
                                                </td>
                                            </tr>
                                        </table>
